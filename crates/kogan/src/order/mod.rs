...
impl FromStr for OrderShippingCarrier {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "ADSONE" | "ADSOne" => Ok(Self::ADSONE),
            "SENDLE" | "Sendle" => Ok(Self::SENDLE),
            "COPE" | "COPE Sensitive Freight" => Ok(Self::COPE),
            "BPOST" | "Bpost" => Ok(Self::BPOST),
            "SHIPPIT" | "Shippit" => Ok(Self::SHIPPIT),
            "MEGASAVE" | "Megasave" => Ok(Self::MEGASAVE),
